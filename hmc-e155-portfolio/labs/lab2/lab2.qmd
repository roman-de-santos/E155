...
![Figure 3: Calculations for 7-Seg and LED Resitor Value](images/Calculation1.png)
...
![Figure 5: top_tb Waves](images/topTB1.png)
![Figure 6: top_tb Output](images/topTB2.png)

Figure 5 shows the Testbench Wave output for the top module.

Figure 6 shows the console output for the testbench, we can see all 256 unique tests pass with 0 errors.

![Figure 67: DispMux_tb Waves](images/DispMuxTB.png)

Figure 7 shows the testbench wave output for the DispMux. We can see that the clock succesfuly drives the clock divider and all of its dependent signals.

![Figure 8: SegDispTB](images/SegDispTB.png)

Figure 8 shows the testbench wave output for the seven segment decoder and all of the testcases passed.
...
![Figure 9: Completed Board](images/Board.jpg)
